...
class SecurePreferencesManager @Inject constructor(
    ...
    override val kidSafeModeEnabled: Flow<Boolean> = _kidSafeModeEnabled.asStateFlow()

    private val _deleteProtectionEnabled = MutableStateFlow(getDeleteProtectionEnabled())
    override val deleteProtectionEnabled: Flow<Boolean> = _deleteProtectionEnabled.asStateFlow()
